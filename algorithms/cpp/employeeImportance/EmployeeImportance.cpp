...
* need to return the total importance value of this employee and all his subordinates.
...
// 36 ms, faster than 38.06% of C++, 15.5 MB, less than 64.29% of C++
class Solution {
public:
