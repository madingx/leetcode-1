 ...
 * 
 * Note:
 * 1.The order of the result is not important. So in the above example, [5, 3] is also 
 * correct.
 * 2.Your algorithm should run in linear runtime complexity. Could you implement it using 
